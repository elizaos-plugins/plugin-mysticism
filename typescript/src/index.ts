...
export { readingFollowupAction, deepenReadingAction } from "./actions/reading-followup";
...
export const mysticismPlugin: Plugin = {
  ...
  init: async (config: Record<string, string>, _runtime: IAgentRuntime) => {
    for (const key of ["MYSTICISM_PRICE_TAROT", "MYSTICISM_PRICE_ICHING", "MYSTICISM_PRICE_ASTROLOGY"]) {
  ...
  actions: [
    {
      ...
      validate: async (runtime, message, state) =>
        (await import("./actions/tarot-reading")).tarotReadingAction.validate(runtime, message, state),
      handler: async (runtime, message, state, options, callback) =>
        (await import("./actions/tarot-reading")).tarotReadingAction.handler(runtime, message, state, options, callback),
      examples: [[
        { name: "{{user1}}", content: { text: "Can you do a tarot reading for me?" } },
        { name: "{{agentName}}", content: { text: "I'd be happy to do a tarot reading for you. Let me shuffle the cards..." } },
      ]],
    },
    {
      name: "ICHING_READING",
      ...
      validate: async (runtime, message, state) =>
        (await import("./actions/iching-reading")).ichingReadingAction.validate(runtime, message, state),
      handler: async (runtime, message, state, options, callback) =>
        (await import("./actions/iching-reading")).ichingReadingAction.handler(runtime, message, state, options, callback),
      examples: [[
        { name: "{{user1}}", content: { text: "I'd like to consult the I Ching" } },
        { name: "{{agentName}}", content: { text: "Let us consult the ancient oracle. I'll cast the coins for your hexagram..." } },
      ]],
    },
    {
      ...
      validate: async (runtime, message, state) =>
        (await import("./actions/astrology-reading")).astrologyReadingAction.validate(runtime, message, state),
      handler: async (runtime, message, state, options, callback) =>
        (await import("./actions/astrology-reading")).astrologyReadingAction.handler(runtime, message, state, options, callback),
      examples: [[
        { name: "{{user1}}", content: { text: "Can you read my birth chart?" } },
        { name: "{{agentName}}", content: { text: "I'd love to explore your natal chart. First, I'll need your birth details..." } },
      ]],
    },
    {
      ...
      validate: async (runtime, message, state) =>
        (await import("./actions/reading-followup")).readingFollowupAction.validate(runtime, message, state),
      handler: async (runtime, message, state, options, callback) =>
        (await import("./actions/reading-followup")).readingFollowupAction.handler(runtime, message, state, options, callback),
      examples: [[
        { name: "{{user1}}", content: { text: "Yes, that resonates. What's next?" } },
        { name: "{{agentName}}", content: { text: "Let me reveal the next element of your reading..." } },
      ]],
    },
    {
      name: "DEEPEN_READING",
      ...
      validate: async (runtime, message, state) =>
        (await import("./actions/reading-followup")).deepenReadingAction.validate(runtime, message, state),
      handler: async (runtime, message, state, options, callback) =>
        (await import("./actions/reading-followup")).deepenReadingAction.handler(runtime, message, state, options, callback),
      examples: [[
        { name: "{{user1}}", content: { text: "Tell me more about that card" } },
        { name: "{{agentName}}", content: { text: "Let me explore that element more deeply for you..." } },
      ]],
    },
    {
      ...
      validate: async (runtime, message, state) =>
        (await import("./actions/request-payment")).requestPaymentAction.validate(runtime, message, state),
      handler: async (runtime, message, state, options, callback) =>
        (await import("./actions/request-payment")).requestPaymentAction.handler(runtime, message, state, options, callback),
      examples: [[
        { name: "{{agentName}}", content: { text: "For a full Celtic Cross reading, I'd ask $3.00.", actions: ["REQUEST_PAYMENT"] } },
      ]],
    },
    {
      name: "CHECK_PAYMENT",
      ...
      validate: async (runtime, message, state) =>
        (await import("./actions/check-payment")).checkPaymentAction.validate(runtime, message, state),
      handler: async (runtime, message, state, options, callback) =>
        (await import("./actions/check-payment")).checkPaymentAction.handler(runtime, message, state, options, callback),
      examples: [[
        { name: "{{agentName}}", content: { text: "Let me check if your payment has come through...", actions: ["CHECK_PAYMENT"] } },
      ]],
    },
  ],
  ...
  providers: [
    {
      ...
      description:
        "Provides context about the active mystical reading session",
    ...
    },
    {
      ...
      description:
        "Provides mystical domain knowledge to ground the agent's interpretations",
      get: async (runtime, message, state) => {
